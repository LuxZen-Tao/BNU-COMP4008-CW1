...
public class ShipShootingPlayer2 : MonoBehaviour
{
    ...
    void HandleShooting()
    {
        // Fire when the '#' key is pressed and the cooldown allows
        if (Input.GetKeyDown(KeyCode.Hash) && Time.time >= nextFireTime)
        {
